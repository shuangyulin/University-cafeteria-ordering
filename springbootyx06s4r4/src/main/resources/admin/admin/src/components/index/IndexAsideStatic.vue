	...
	mounted() {
		...
		this.$http({
			...
			if (data && data.code === 0) {
				...
				if(sessionTable == 'shitangshangjia') {
					this.avatar = data.data.touxiang
				}
...
// 					// }
	...
	.scrollbar-wrapper-open .el-menu-vertical-2>.el-menu-item.other>.el-tooltip:hover {
		...
		box-shadow: 0px 1px 5px 0px #EB8318 !important;
		color: #fff !important;
		background: linear-gradient(0deg, rgba(255,205,156,1) 0%, rgba(246,152,54,1) 100%) !important;
	}
	...
	.scrollbar-wrapper-open .el-menu-vertical-2>.el-menu-item.home>.el-tooltip:hover {
		border-radius: 10px;
		box-shadow: 0px 1px 5px 0px #EB8318;
		color: #fff;
		background: linear-gradient(0deg, rgba(255,205,156,1) 0%, rgba(246,152,54,1) 100%);
	}
