	...
	<view class="content">
		<view class="box" :style='{"width":"100%","padding":"20rpx","background":"#F6F7F9","height":"100%"}' v-if="type==1">
			<view :style='{"width":"100%","padding":"24rpx","display":"block","height":"auto"}'>
				...
				<picker :style='{"border":"2rpx solid #3D3D3D","width":"100%","padding":"0 20rpx","margin":"0 0 24rpx 0","borderRadius":"8rpx","height":"auto"}' @change="optionsChange" :value="index" :range="options">
