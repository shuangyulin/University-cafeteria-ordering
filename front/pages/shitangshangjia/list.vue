			...
			<view :style='{"minHeight":"100%","width":"100%","padding":"20rpx 20rpx 198rpx","position":"relative","background":"#F6F7F9","height":"auto"}'>
				<view class="cu-bar bg-white search" :style='{"width":"100%","padding":"0","background":"none","display":"flex","height":"auto","order":"1"}'>
					<view :style='{"margin":"0","flex":"1","position":"relative"}' class="search-form round">
						...
						<input placeholder-style="color: #333" :style='{"border":"2rpx solid #FFD128","padding":"12rpx 20rpx 12rpx 80rpx","color":"#333","borderRadius":"0","background":"#fff","width":"100%","lineHeight":"56rpx","fontSize":"28rpx","height":"80rpx"}' v-model="searchForm.dianpuming" type="text" placeholder="店铺名" ></input>
					</view>
						...
						<block v-for="(list,indexOut) in lists" :key="indexOut">
							<block v-for="(product,index) in list" :key="index">
								<view @tap="onDetailTap(product)" v-if="index%6==0" class="list-item" :style='{"boxShadow":"none","padding":"20rpx","margin":"0 0 20rpx","borderRadius":"20rpx","flexWrap":"wrap","background":"#fff","display":"flex","width":"49%","height":"auto"}'>
									<image :style='{"padding":"0","margin":"0","objectFit":"cover","borderRadius":"20rpx","display":"block","width":"100%","height":"220rpx","order":"10"}' mode="aspectFill" v-if="preHttp(product.touxiang)" :src="product.touxiang"></image>
									<image :style='{"padding":"0","margin":"0","objectFit":"cover","borderRadius":"20rpx","display":"block","width":"100%","height":"220rpx","order":"10"}' mode="aspectFill" v-else :src="product.touxiang?baseUrl+product.touxiang.split(',')[0]:''"></image>
									<view :style='{"padding":"0","whiteSpace":"nowrap","overflow":"hidden","color":"#000","width":"100%","lineHeight":"50rpx","fontSize":"30rpx","textOverflow":"ellipsis","fontWeight":"bold"}' class="title">{{product.dianpuming}}</view>
									<view :style='{"padding":"0","whiteSpace":"nowrap","overflow":"hidden","color":"#000","width":"100%","lineHeight":"50rpx","fontSize":"30rpx","textOverflow":"ellipsis","fontWeight":"bold"}' class="title">{{product.lianxifangshi}}</view>
									...
									<view :style='{"width":"100%","padding":"10rpx 0 0","justifyContent":"space-between","display":"flex","height":"auto","order":"11"}'>
										<view :style='{"display":"flex"}' v-if="(userid && isAuth('shitangshangjia','修改')) || (!userid && isAuthFront('shitangshangjia','修改'))" @tap.stop.proevent="onUpdate" :data-row="product">
										...
										<view :style='{"display":"flex"}' v-if="(userid && isAuth('shitangshangjia','删除')) || (!userid && isAuthFront('shitangshangjia','删除'))" @tap.stop.proevent="onDelete" :data-row="product">
									...
									<!-- #ifndef MP-WEIXIN -->
									<view :style='{"width":"100%","padding":"10rpx 0 0","justifyContent":"space-between","display":"flex","height":"auto","order":"11"}'>
										<view :style='{"display":"flex"}' v-if="(userid && isAuth('shitangshangjia','修改')) || (!userid && isAuthFront('shitangshangjia','修改'))" @tap.stop.proevent="onUpdateTap(product)">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#FFD128","display":"inline-block"}' class="cuIcon-edit"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#FFD128","display":"inline-block"}'>修改</text>
										</view>
										<view :style='{"display":"flex"}' v-if="(userid && isAuth('shitangshangjia','删除')) || (!userid && isAuthFront('shitangshangjia','删除'))" @tap.stop.proevent="onDeleteTap(product.id)">
											<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"40rpx","color":"#959595","display":"inline-block"}' class="cuIcon-delete"></text>
											<text :style='{"fontSize":"28rpx","lineHeight":"40rpx","color":"#959595","display":"inline-block"}'>删除</text>
										</view>
									</view>
								...
								<view @tap="onDetailTap(product)" v-if="index%6==4" class="list-item" :style='{"boxShadow":"none","padding":"20rpx","margin":"0 0 20rpx","borderRadius":"20rpx","flexWrap":"wrap","background":"#fff","display":"flex","width":"49%","height":"auto"}'>
									<image :style='{"width":"100rpx","objectFit":"cover","borderRadius":"20rpx","display":"block","height":"100rpx","order":"1"}' mode="aspectFill" v-if="preHttp(product.touxiang)" :src="product.touxiang"></image>
									<image :style='{"width":"100rpx","objectFit":"cover","borderRadius":"20rpx","display":"block","height":"100rpx","order":"1"}' mode="aspectFill" v-else :src="product.touxiang?baseUrl+product.touxiang.split(',')[0]:''"></image>
									<view class="list-item-body" :style='{"width":"calc(100% - 100rpx)","padding":"0","margin":"0","flexWrap":"wrap","display":"flex","height":"auto"}'>
										<view :style='{"padding":"0","margin":"0","color":"#000","width":"100%","lineHeight":"48rpx","fontSize":"30rpx","fontWeight":"bold"}' class="title">{{product.dianpuming}}</view>
										<view :style='{"padding":"0","margin":"0","color":"#000","width":"100%","lineHeight":"48rpx","fontSize":"30rpx","fontWeight":"bold"}' class="title">{{product.lianxifangshi}}</view>
										<view :style='{"padding":"0 20rpx 0 0","order":"5"}'>
											<text class="icon iconfont icon-shijian21" :style='{"margin":"0 4rpx 0 0","lineHeight":"50rpx","fontSize":"24rpx","color":"#959595"}'></text>
				...
				<button :style='{"border":"0","boxShadow":"none","color":"#fff","bottom":"128rpx","outline":"none","borderRadius":"100%","left":"20rpx","background":"#FFD128","width":"80rpx","lineHeight":"80rpx","fontSize":"28rpx","position":"fixed","height":"80rpx","zIndex":"999"}' class="add-btn" @click="screenBoxShow=true">筛</button>
				<button :style='{"border":"0","boxShadow":"none","color":"rgb(255, 255, 255)","bottom":"128rpx","right":"128rpx","outline":"none","borderRadius":"100%","background":"#FFD128","width":"80rpx","lineHeight":"80rpx","fontSize":"28rpx","position":"fixed","height":"80rpx","zIndex":"999"}' v-if="userid && isAuth('shitangshangjia','新增')" class="add-btn" @click="onAddTap()">新增</button>
				<button :style='{"border":"0","boxShadow":"none","color":"rgb(255, 255, 255)","bottom":"128rpx","right":"128rpx","outline":"none","borderRadius":"100%","background":"#FFD128","width":"80rpx","lineHeight":"80rpx","fontSize":"28rpx","position":"fixed","height":"80rpx","zIndex":"999"}' v-if="!userid && isAuthFront('shitangshangjia','新增')" class="add-btn" @click="onAddTap()">新增</button>
				<view :style='{"top":"0","left":"0","background":"rgba(0, 0, 0, .3)","width":"100%","position":"fixed","height":"100%","zIndex":"665"}' v-if="screenBoxShow" @click="screenBoxShow=false"></view>
				<view class="screenBox" :class="screenBoxShow?'screenBoxActive':''">
					<view :style='{"width":"100%","padding":"20rpx 0 20rpx 0","alignItems":"center","justifyContent":"space-around","display":"flex"}'>
						<view :style='{"width":"18%","padding":"0 0 0 20rpx","fontSize":"24rpx"}'>店铺位置</view>
						<input :style='{"border":"0","width":"80%","padding":"0 20rpx 0 20rpx","borderRadius":"40rpx","background":"#eee","height":"60rpx"}' placeholder="请输入店铺位置" v-model="searchForm.dianpuweizhi">
					</view>
					<view :style='{"width":"100%","padding":"40rpx 0 0","alignItems":"center","justifyContent":"space-around","display":"flex"}'>
						<div :style='{"width":"30%","lineHeight":"60rpx","color":"#888","textAlign":"center","background":"#eee","height":"60rpx"}' @click="screenReset">重置</div>
						<div :style='{"width":"30%","lineHeight":"60rpx","color":"#fff","textAlign":"center","background":"#FFD128","height":"60rpx"}' @click="search">搜索</div>
					</view>
				</view>
			</view>
		</view>
	...
	export default {
		...
		methods: {
			...
			async upCallback(mescroll) {
				...
				if(this.searchForm.dianpuweizhi){
					params['dianpuweizhi'] = '%' + this.searchForm.dianpuweizhi + '%'
				}
				let user = uni.getStorageSync("appUserid")?JSON.parse(uni.getStorageSync('userSession')):{}
                let res = {}
                if(this.userid) {
                    res = await this.$api.page(`shitangshangjia`, params);
                } else {
                    res = await this.$api.list(`shitangshangjia`, params);
                }
			...
			onDeleteTap(id){
				...
				uni.showModal({
					...
					success: async function(res) {
						if (res.confirm) {
							await _this.$api.del('shitangshangjia', JSON.stringify([id]));
			...
			async search(){
				...
				if(this.searchForm.dianpuweizhi){
					searchForm['dianpuweizhi'] = '%' + this.searchForm.dianpuweizhi + '%'
				}
                let res = {};
                if(this.userid) {
                    res = await this.$api.page(`shitangshangjia`, searchForm);
                } else {
                    res = await this.$api.list(`shitangshangjia`, searchForm);
                }
				// 如果是第一页数据置空
