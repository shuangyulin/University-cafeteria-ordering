...
--
-- Host: localhost    Database: springbootyx06s4r4
-- ------------------------------------------------------
...
--
-- Current Database: `springbootyx06s4r4`
--

/*!40000 DROP DATABASE IF EXISTS `springbootyx06s4r4`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `springbootyx06s4r4` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;

USE `springbootyx06s4r4`;
...
CREATE TABLE `caipinfenlei` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `caipinfenlei` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '菜品分类',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='菜品分类';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `caipinfenlei` VALUES (1,'2025-06-01 14:37:51','菜品分类1'),(2,'2025-06-01 14:37:51','菜品分类2'),(3,'2025-06-01 14:37:51','菜品分类3'),(4,'2025-06-01 14:37:51','菜品分类4'),(5,'2025-06-01 14:37:51','菜品分类5'),(6,'2025-06-01 14:37:51','菜品分类6'),(7,'2025-06-01 14:37:51','菜品分类7'),(8,'2025-06-01 14:37:51','菜品分类8');
...
CREATE TABLE `caipinxinxi` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `caipinbianhao` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '菜品编号',
  `caipinmingcheng` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '菜品名称',
  `caipinfenlei` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '菜品分类',
  `tupian` longtext COLLATE utf8mb4_unicode_ci COMMENT '图片',
  `kouweipianhao` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '口味偏好',
  ...
  `dianpuming` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '店铺名',
  `lianxifangshi` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '联系方式',
  `dianpuweizhi` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '店铺位置',
  ...
  KEY `caipinxinxi_price` (`price`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='菜品信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `caipinxinxi` VALUES (1,'2025-06-01 14:37:51','1111111111','菜品名称1','菜品分类1','upload/caipinxinxi_tupian1.jpg,upload/caipinxinxi_tupian2.jpg,upload/caipinxinxi_tupian3.jpg','口味偏好1','简介1','商家账号1','店铺名1','联系方式1','店铺位置1',1,99,0,99.9,1,1),(2,'2025-06-01 14:37:51','2222222222','菜品名称2','菜品分类2','upload/caipinxinxi_tupian2.jpg,upload/caipinxinxi_tupian3.jpg,upload/caipinxinxi_tupian4.jpg','口味偏好2','简介2','商家账号2','店铺名2','联系方式2','店铺位置2',2,99,0,99.9,1,2),(3,'2025-06-01 14:37:51','3333333333','菜品名称3','菜品分类3','upload/caipinxinxi_tupian3.jpg,upload/caipinxinxi_tupian4.jpg,upload/caipinxinxi_tupian5.jpg','口味偏好3','简介3','商家账号3','店铺名3','联系方式3','店铺位置3',3,99,0,99.9,1,3),(4,'2025-06-01 14:37:51','4444444444','菜品名称4','菜品分类4','upload/caipinxinxi_tupian4.jpg,upload/caipinxinxi_tupian5.jpg,upload/caipinxinxi_tupian6.jpg','口味偏好4','简介4','商家账号4','店铺名4','联系方式4','店铺位置4',4,99,0,99.9,1,4),(5,'2025-06-01 14:37:51','5555555555','菜品名称5','菜品分类5','upload/caipinxinxi_tupian5.jpg,upload/caipinxinxi_tupian6.jpg,upload/caipinxinxi_tupian7.jpg','口味偏好5','简介5','商家账号5','店铺名5','联系方式5','店铺位置5',5,99,0,99.9,1,5),(6,'2025-06-01 14:37:51','6666666666','菜品名称6','菜品分类6','upload/caipinxinxi_tupian6.jpg,upload/caipinxinxi_tupian7.jpg,upload/caipinxinxi_tupian8.jpg','口味偏好6','简介6','商家账号6','店铺名6','联系方式6','店铺位置6',6,99,0,99.9,1,6),(7,'2025-06-01 14:37:51','7777777777','菜品名称7','菜品分类7','upload/caipinxinxi_tupian7.jpg,upload/caipinxinxi_tupian8.jpg,upload/caipinxinxi_tupian1.jpg','口味偏好7','简介7','商家账号7','店铺名7','联系方式7','店铺位置7',7,99,0,99.9,1,7),(8,'2025-06-01 14:37:51','8888888888','菜品名称8','菜品分类8','upload/caipinxinxi_tupian8.jpg,upload/caipinxinxi_tupian1.jpg,upload/caipinxinxi_tupian2.jpg','口味偏好8','简介8','商家账号8','店铺名8','联系方式8','店铺位置8',8,99,0,99.9,1,8);
...
CREATE TABLE `cart` (
  ...
  PRIMARY KEY (`id`),
  KEY `price` (`price`),
  CONSTRAINT `cart_ibfk_1` FOREIGN KEY (`price`) REFERENCES `caipinxinxi` (`price`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `chargerecord` VALUES (1,'2025-06-01 14:37:51',1,'用户名1','角色1',1),(2,'2025-06-01 14:37:51',2,'用户名2','角色2',2),(3,'2025-06-01 14:37:51',3,'用户名3','角色3',3),(4,'2025-06-01 14:37:51',4,'用户名4','角色4',4),(5,'2025-06-01 14:37:51',5,'用户名5','角色5',5),(6,'2025-06-01 14:37:51',6,'用户名6','角色6',6),(7,'2025-06-01 14:37:51',7,'用户名7','角色7',7),(8,'2025-06-01 14:37:51',8,'用户名8','角色8',8);
...
INSERT INTO `chat` VALUES (1,'2025-06-01 14:37:51',1,1,'提问1','回复1',1,1,'用户头像1','upload/chat_uimage1.jpg,upload/chat_uimage2.jpg,upload/chat_uimage3.jpg',1),(2,'2025-06-01 14:37:51',2,2,'提问2','回复2',2,2,'用户头像2','upload/chat_uimage2.jpg,upload/chat_uimage3.jpg,upload/chat_uimage4.jpg',2),(3,'2025-06-01 14:37:51',3,3,'提问3','回复3',3,3,'用户头像3','upload/chat_uimage3.jpg,upload/chat_uimage4.jpg,upload/chat_uimage5.jpg',3),(4,'2025-06-01 14:37:51',4,4,'提问4','回复4',4,4,'用户头像4','upload/chat_uimage4.jpg,upload/chat_uimage5.jpg,upload/chat_uimage6.jpg',4),(5,'2025-06-01 14:37:51',5,5,'提问5','回复5',5,5,'用户头像5','upload/chat_uimage5.jpg,upload/chat_uimage6.jpg,upload/chat_uimage7.jpg',5),(6,'2025-06-01 14:37:51',6,6,'提问6','回复6',6,6,'用户头像6','upload/chat_uimage6.jpg,upload/chat_uimage7.jpg,upload/chat_uimage8.jpg',6),(7,'2025-06-01 14:37:51',7,7,'提问7','回复7',7,7,'用户头像7','upload/chat_uimage7.jpg,upload/chat_uimage8.jpg,upload/chat_uimage1.jpg',7),(8,'2025-06-01 14:37:51',8,8,'提问8','回复8',8,8,'用户头像8','upload/chat_uimage8.jpg,upload/chat_uimage1.jpg,upload/chat_uimage2.jpg',8);
...
--
-- Table structure for table `discussshitangshangjia`
--

DROP TABLE IF EXISTS `discussshitangshangjia`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `discussshitangshangjia` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `refid` bigint(20) NOT NULL COMMENT '关联表id',
  `userid` bigint(20) NOT NULL COMMENT '用户id',
  ...
  `cuserids` longtext COLLATE utf8mb4_unicode_ci COMMENT '踩用户ids',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='食堂商家评论表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `discussshitangshangjia`
--

LOCK TABLES `discussshitangshangjia` WRITE;
/*!40000 ALTER TABLE `discussshitangshangjia` DISABLE KEYS */;
/*!40000 ALTER TABLE `discussshitangshangjia` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `newstype` VALUES (1,'2025-06-01 14:37:51','分类名称1'),(2,'2025-06-01 14:37:51','分类名称2'),(3,'2025-06-01 14:37:51','分类名称3'),(4,'2025-06-01 14:37:51','分类名称4'),(5,'2025-06-01 14:37:51','分类名称5'),(6,'2025-06-01 14:37:51','分类名称6'),(7,'2025-06-01 14:37:51','分类名称7'),(8,'2025-06-01 14:37:51','分类名称8');
...
--
-- Table structure for table `shitangshangjia`
--

DROP TABLE IF EXISTS `shitangshangjia`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shitangshangjia` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  ...
  `dianpuming` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '店铺名',
  `dianpuweizhi` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '店铺位置',
  `lianxifangshi` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '联系方式',
  ...
  `jieshao` longtext COLLATE utf8mb4_unicode_ci COMMENT '介绍',
  `discussnum` int(11) DEFAULT '0' COMMENT '评论数',
  `storeupnum` int(11) DEFAULT '0' COMMENT '收藏数',
  `money` double DEFAULT '0' COMMENT '余额',
  PRIMARY KEY (`id`),
  UNIQUE KEY `shangjiazhanghao` (`shangjiazhanghao`)
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='食堂商家';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `shitangshangjia`
--

LOCK TABLES `shitangshangjia` WRITE;
/*!40000 ALTER TABLE `shitangshangjia` DISABLE KEYS */;
INSERT INTO `shitangshangjia` VALUES (21,'2025-06-01 14:37:51','商家账号1','ED5wLgc3Mnw=','店铺名1','店铺位置1','13823888881','联系人1','upload/shitangshangjia_touxiang1.jpg','介绍1',0,1,200),(22,'2025-06-01 14:37:51','商家账号2','ED5wLgc3Mnw=','店铺名2','店铺位置2','13823888882','联系人2','upload/shitangshangjia_touxiang2.jpg','介绍2',0,2,200),(23,'2025-06-01 14:37:51','商家账号3','ED5wLgc3Mnw=','店铺名3','店铺位置3','13823888883','联系人3','upload/shitangshangjia_touxiang3.jpg','介绍3',0,3,200),(24,'2025-06-01 14:37:51','商家账号4','ED5wLgc3Mnw=','店铺名4','店铺位置4','13823888884','联系人4','upload/shitangshangjia_touxiang4.jpg','介绍4',0,4,200),(25,'2025-06-01 14:37:51','商家账号5','ED5wLgc3Mnw=','店铺名5','店铺位置5','13823888885','联系人5','upload/shitangshangjia_touxiang5.jpg','介绍5',0,5,200),(26,'2025-06-01 14:37:51','商家账号6','ED5wLgc3Mnw=','店铺名6','店铺位置6','13823888886','联系人6','upload/shitangshangjia_touxiang6.jpg','介绍6',0,6,200),(27,'2025-06-01 14:37:51','商家账号7','ED5wLgc3Mnw=','店铺名7','店铺位置7','13823888887','联系人7','upload/shitangshangjia_touxiang7.jpg','介绍7',0,7,200),(28,'2025-06-01 14:37:51','商家账号8','ED5wLgc3Mnw=','店铺名8','店铺位置8','13823888888','联系人8','upload/shitangshangjia_touxiang8.jpg','介绍8',0,8,200);
/*!40000 ALTER TABLE `shitangshangjia` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `users` VALUES (1,'admin','admin','upload/image1.jpg','管理员','2025-06-01 14:37:51');
...
INSERT INTO `yonghu` VALUES (11,'2025-06-01 14:37:51','用户账号1','ED5wLgc3Mnw=','用户姓名1','男','年龄1','upload/yonghu_touxiang1.jpg',200),(12,'2025-06-01 14:37:51','用户账号2','ED5wLgc3Mnw=','用户姓名2','男','年龄2','upload/yonghu_touxiang2.jpg',200),(13,'2025-06-01 14:37:51','用户账号3','ED5wLgc3Mnw=','用户姓名3','男','年龄3','upload/yonghu_touxiang3.jpg',200),(14,'2025-06-01 14:37:51','用户账号4','ED5wLgc3Mnw=','用户姓名4','男','年龄4','upload/yonghu_touxiang4.jpg',200),(15,'2025-06-01 14:37:51','用户账号5','ED5wLgc3Mnw=','用户姓名5','男','年龄5','upload/yonghu_touxiang5.jpg',200),(16,'2025-06-01 14:37:51','用户账号6','ED5wLgc3Mnw=','用户姓名6','男','年龄6','upload/yonghu_touxiang6.jpg',200),(17,'2025-06-01 14:37:51','用户账号7','ED5wLgc3Mnw=','用户姓名7','男','年龄7','upload/yonghu_touxiang7.jpg',200),(18,'2025-06-01 14:37:51','用户账号8','ED5wLgc3Mnw=','用户姓名8','男','年龄8','upload/yonghu_touxiang8.jpg',200);
...
-- Dump completed on 2025-06-02  7:31:04
